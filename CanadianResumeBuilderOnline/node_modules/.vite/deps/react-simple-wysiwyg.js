...
var ContentEditable = import_react.default.memo(import_react.default.forwardRef(function ContentEditable2(_a, ref) {
  ...
  return import_react.default.useMemo(function() {
    ...
    return import_react.default.createElement(tagName || "div", __assign(__assign({}, rest), { className, contentEditable: !disabled, dangerouslySetInnerHTML: { __html: value }, onBlur: function(e2) {
...
function HtmlEditor(_a) {
  var rest = __rest(_a, []);
  return import_react.default.createElement("textarea", __assign({}, rest));
}
var e = [];
var t = [];
function n(n2, r) {
...
function Editor(_a) {
  ...
  if (editorState.htmlMode) {
    return import_react.default.createElement(
      "div",
      __assign({ className: "rsw-editor" }, containerProps),
      children,
      import_react.default.createElement(HtmlEditor, __assign({}, rest, { className: "rsw-ce rsw-html" }))
    );
  }
  return import_react.default.createElement(
    "div",
    __assign({ className: "rsw-editor" }, containerProps),
    children,
    import_react.default.createElement(ContentEditable, __assign({}, rest, { ref: setContentEditableRef, onSelect: onTextSelect, className: "rsw-ce" }))
  );
}
